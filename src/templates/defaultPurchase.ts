...
<div style="font-family: 'Cairo', sans-serif; direction: rtl; padding: 40px; background-color: #ffffff; color: #333; line-height: 1.6;">
  <!-- Header -->
  <div style="display: flex; justify-content: space-between; align-items: flex-start; border-bottom: 4px solid #16a34a; padding-bottom: 20px; margin-bottom: 30px;">
    <div style="display: flex; align-items: center; gap: 20px;">
      {{logo_img}}
      <div>
        <h1 style="margin: 0; font-size: 28px; color: #16a34a; font-weight: bold;">{{company_name}}</h1>
    ...
    <div style="background-color: #f0fdf4; border: 1px solid #bbf7d0; padding: 20px; border-radius: 12px; min-width: 250px;">
      <h2 style="margin: 0 0 15px; font-size: 22px; color: #16a34a; font-weight: bold; border-bottom: 2px solid #bbf7d0; padding-bottom: 10px;">{{invoice_type_label}}</h2>
  ...
  <!-- Party Info -->
  <div style="background-color: #f8fafc; border-right: 4px solid #16a34a; padding: 20px; border-radius: 8px; margin-bottom: 30px; display: flex; justify-content: space-between;">
    <div>
  ...
  <table style="width: 100%; border-collapse: collapse; margin-bottom: 30px;">
    <thead>
      <tr style="background-color: #16a34a; color: #ffffff;">
        <th style="padding: 12px; text-align: right; border: 1px solid #15803d;">الصنف</th>
        <th style="padding: 12px; text-align: center; border: 1px solid #15803d; width: 100px;">الكمية</th>
        <th style="padding: 12px; text-align: center; border: 1px solid #15803d; width: 120px;">السعر</th>
        <th style="padding: 12px; text-align: center; border: 1px solid #15803d; width: 120px;">الإجمالي</th>
      </tr>
    </thead>
    <tbody>
      {{items_table_rows}}
  ...
  <div style="display: flex; justify-content: flex-end; margin-bottom: 40px;">
    <div style="width: 300px; border: 1px solid #e2e8f0; border-radius: 8px; overflow: hidden;">
      ...
      <div style="display: flex; justify-content: space-between; padding: 15px; background-color: #f0fdf4;">
        <span style="font-size: 18px; font-weight: bold; color: #16a34a;">الإجمالي المستحق:</span>
        <span style="font-size: 18px; font-weight: bold; color: #16a34a;">{{total}}</span>
      </div>
    </div>
  </div>
